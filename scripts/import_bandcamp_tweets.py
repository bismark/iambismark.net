...
with open('bandcamp_tweets.json', 'r') as f:
    tweets = json.load(f)
    for tweet_id, tweet in tweets.iteritems():
        ...
        metadata['type'] = 'bandcamp'
        metadata['title'] = tweet['description']
        ...
        with codecs.open(output_filename, 'w', encoding='utf-8') as output_file:
            ...
            if 'track' in tweet:
                output = "{{{{< bandcamp_track album=\"{}\" track=\"{}\" url=\"{}\" description=\"{}\" >}}}}".format(tweet['album'], tweet['track'], tweet['url'], tweet['description'])
            else:
                output = "{{{{< bandcamp_album album=\"{}\" url=\"{}\" description=\"{}\" >}}}}".format(tweet['album'], tweet['url'], tweet['description'])
